...
@Serializable
data class Formats(
    @SerialName("thumbnail") val thumbnail: ImageFormat? = null,
    @SerialName("xsmall") val xsmall: ImageFormat? = null,
    @SerialName("small") val small: ImageFormat? = null,
    @SerialName("medium") val medium: ImageFormat? = null,
